...
def graficar(medidos,simulados):
    ...
    plt.scatter(medidos,simulados,s=8,color='black',zorder=2)
    a=np.linspace(0,160,160)
...
ruta_guardado=r'C:\Users\sergi\OneDrive\Documents\Universidad\Informe_joven_investigador\Informe_final\graficos\Validacion_interpolacion'
plt.savefig(ruta_guardado+'\\'+'Resultados_validacion.png')
plt.show()
