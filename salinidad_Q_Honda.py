...
ruta_HEC_RAS_nivel=ruta_archivos+'\\'+'Niveles_ras_QH.xls' #Archivo de niveles (salida HEC-RAS)
ruta_HEC_RAS_caudal=ruta_archivos+'\\'+'Caudales_ras_QH.xls' #Archivo de caudal (salida HEC-RAS)
tributarios_HEC_HMS=ruta_archivos+'\\'+'Tributarios_QH_2018.xls' #Tributarios de HEC-HMS (salida HEC-HMS)
...
salinidad_efl=convertir_dataframe(conc,fecha,Estaciones)

pot_sal=potencial_de_salinidad(conc,0.03)

# print(convertir_dataframe(nivel,fecha,Estaciones))

salinidad_efl.to_excel(ruta_archivos+'\\'+'Salinidad_Quebrada_Honda.xlsx')
print(datetime.now())

ruta_guardado=r'C:\Users\sergi\Desktop\Prueba_SISE\2014\Resultados\Quebrada_Honda'
...
convertir_dataframe(pot_sal,fecha,Estaciones).to_excel(ruta_guardado+'\\'+'pot_sal.xlsx')
